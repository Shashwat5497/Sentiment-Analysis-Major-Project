...
if(st.button("Click to see Sentiment of the tweet.")):
  op = text_model.predict_proba([select])
  st.header('Positive     Neutral      Negative')
  st.subheader(op[0,0]+"%     "+op[0,1]+"%      "+op[0,2]+"%")
